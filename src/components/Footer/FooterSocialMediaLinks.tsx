  ...
  return (
    <li>
      <Link href={href} target="_blank" rel="noopener noreferrer">
        <div className="border border-border/40 flex items-center justify-center w-10 h-10 rounded-full hover:bg-purple-500 hover:text-primary transition-colors duration-300">
          {icon}
        </div>
      </Link>
    </li>
